srcPackage {
    ...
    depends={
        "ocaml", "gtk+2-bin", "lablgl", "gtkglarea",
    },
    sh=[=[
set -x
...
export PKG_CONFIG_PATH="$CCS_TARGET_ROOT/../gtk+2-bin/lib/pkgconfig:$PKG_CONFIG_PATH"
...
s|^USE_GL=.*|USE_GL=1| || \
s|C:/opt/gtk|$CCS_TARGET_ROOT/../gtk+2-bin|g || \
s|^LABLGLDIR=.*|LABLGLDIR=$CCS_TARGET_ROOT/lib/lablGL| || \
s|^GTKGL_LIBS =|GTKGL_LIBS=-L$CCS_TARGET_ROOT/../gtk+2-bin/lib -lgtkgl-2.0| || \
s|^prefix=.*|prefix=$CCS_TARGET_ROOT| || \
s|C:\\\\Program Files\\\\Objective Caml\\\\|$CCS_TARGET_ROOT/| || \
1; \
s|^(GTKCFLAGS=.*)|\\1\
 -I$CCS_TARGET_ROOT/../gtk+2-bin/include/gtkgl-2.0\
 -I$CCS_TARGET_ROOT/../gtk+2-bin/include/gdk-pixbuf-2.0\
| || \
1; \
...
#perl -i.bak -pe "\
#s|c:/devel/target/d7fd1ca0216656a73e6b25377ec11a8c|$CCS_TARGET_ROOT/../gtk+2-bin| \
#" config.make
