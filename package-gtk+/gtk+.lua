...
export LDFLAGS="$LDFLAGS `pkg-config --libs glib-2.0` `pkg-config --libs pango` `pkg-config --libs cairo` `pkg-config --libs gobject-2.0` `pkg-config --libs gio-2.0` `pkg-config --libs gdk-pixbuf-2.0`"
